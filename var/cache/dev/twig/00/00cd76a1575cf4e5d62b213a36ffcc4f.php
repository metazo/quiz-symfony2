...
class __TwigTemplate_bdaed67cc3230fffd91df876d2594d59 extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"titre\">
    ...
    ";
        ...
        // line 19
        echo "    <br><h4>Des quizz dans tous les categories !</h4><br><br><br>
</div>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["categorie"]) {
            ...
            if (twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 30, $this->source); })()), "user", [], "any", false, false, false, 30)) {
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["scoredata"]) {
                    // line 32
                    echo "                    ";
                    if ((twig_get_attribute($this->env, $this->source, $context["categorie"], "id", [], "any", false, false, false, 32) == twig_get_attribute($this->env, $this->source, $context["scoredata"], "id_categorie", [], "any", false, false, false, 32))) {
                        // line 33
                        echo "                        <i> -> ";
                ...
                // line 37
                echo "                ";
                if ((twig_get_attribute($this->env, $this->source, $context["categorie"], "id", [], "any", false, false, false, 37) == (isset($context["id_cat"]) || array_key_exists("id_cat", $context) ? $context["id_cat"] : (function () { throw new RuntimeError('Variable "id_cat" does not exist.', 37, $this->source); })()))) {
                    // line 38
                    echo "                    -> ";
...
{% endblock %}
", "categorie/index.html.twig", "/Users/mac/W-PHP-502-STG-2-1-Quiz-smain1.benai/quizz/templates/categorie/index.html.twig");
    }
}
